...
public class WorkspaceHandler implements BaseHandler {
    ...
    public BaseResponse<WorkspaceRepresentation> addWorkspace(UserRequest request) throws PackageNotFoundException, InconsistentStateException, DBServiceException, PackageCodeNotFoundException, PackageCodeExpiredException, PackageInactiveException {
    ...
    public BaseResponse<CsWorkspaceRepresentation> getWorkspaceOfUser(UserRequest request) throws WorkspaceConfigNotFoundException, WorkspaceNotFoundException, DBServiceException, UserConfigNotFoundException {
    ...
    public BaseResponse<CsWorkspaceRepresentation> getWorkspace(AdminRequest request) throws WorkspaceConfigNotFoundException, WorkspaceNotFoundException, DBServiceException {
    ...
    public BaseResponse<WorkspaceRepresentation> updateWorkspace(WorkspaceRequest request) throws WorkspaceConfigNotFoundException, WorkspaceNotFoundException, DBServiceException {
    ...
    public BaseResponse<WorkspaceRepresentation> upgradeWorkspace(WorkspaceRequest request) throws WorkspaceConfigNotFoundException, WorkspaceNotFoundException, PackageCodeNotFoundException, DBServiceException, PackageCodeExpiredException, PackageNotFoundException, PackageInactiveException {
    ...
    public BaseResponse<CsWorkspaceRepresentation> addUserToWorkspace(WorkspaceRequest request) throws UserProfileNotFoundException, ProductNotFoundException, DBServiceException, PermissionNotFoundException, InvalidDataException {
    ...
    public BaseResponse<CsWorkspaceRepresentation> updateUserOfWorkspace(WorkspaceRequest request) throws UserProfileNotFoundException, ProductNotFoundException, DBServiceException, PermissionNotFoundException, InvalidDataException, UserConfigNotFoundException {
    ...
    public BaseResponse<CsWorkspaceRepresentation> RemoveUserOfWorkspace(WorkspaceRequest request) throws UserProfileNotFoundException, ProductNotFoundException, DBServiceException, PermissionNotFoundException, InvalidDataException, UserConfigNotFoundException {
